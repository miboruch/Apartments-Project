let userInterfaceModule = (function(){
  ...
  const selectArray = [daysFrom, monthsFrom, yearFrom, daysTo, monthsTo, yearTo];
...
let dataModule = (function(UImodule){
  ...
  function getData(){
    try{
      ...
      return [new Person(firstName, lastName, id, card, new Date()),
            new Peroid(getDate(module.yearsArray, yearFrom, monthFrom, dayFrom), getDate(module.yearsArray, yearTo, monthTo, dayTo))];
    }catch(e){
      console.log(e);
    }
  }
