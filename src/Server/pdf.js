...
module.exports = {
  ...
  generatePDF: function(obj){
      ...
      doc.fontSize(10);
      doc.text('This pdf was generated automatically. Keep this document to confirm the reservation.', 100, 660);
      doc.text('marveloushotel.io 760 Market St. 10th Floor, Los Angeles, CA94103', 160, 680);
